...
describe('動きに関するテスト', () => {
  ...
  it('moveLeftBackのテスト', () => {
    ...
    expect(move.moveLeftBack(2, { x: 0, y: 0 })).toEqual([{ x: 1, y: 1 }])
    expect(move.moveLeftBack(2, { x: 8, y: 8 })).toEqual([])
  })
  it('moveKeimaのテスト', () => {
    expect(move.moveKeima(1, { x: 3, y: 3 })).toEqual([{ x: 2, y: 1 }])
  ...
  it('moveFrontStraightのテスト', () => {
    expect(move.moveFrontStraight(1, { x: 3, y: 3 })).toEqual([
      { x: 3, y: 2 },
      { x: 3, y: 1 },
      { x: 3, y: 0 },
    ])
    expect(move.moveFrontStraight(1, { x: 1, y: 0 })).toEqual([])
    expect(move.moveFrontStraight(2, { x: 0, y: 0 })).toEqual([
      { x: 0, y: 1 },
      { x: 0, y: 2 },
      { x: 0, y: 3 },
      { x: 0, y: 4 },
    ...
    expect(move.moveFrontStraight(2, { x: 8, y: 8 })).toEqual([])
  })
  it('moveBackStraightのテスト', () => {
    expect(move.moveBackStraight(1, { x: 3, y: 3 })).toEqual([
      { x: 3, y: 4 },
      { x: 3, y: 5 },
      { x: 3, y: 6 },
      { x: 3, y: 7 },
    ...
    expect(move.moveBackStraight(1, { x: 1, y: 0 })).toEqual([])
    expect(move.moveBackStraight(2, { x: 0, y: 0 })).toEqual([])
    expect(move.moveBackStraight(2, { x: 5, y: 5 })).toEqual([
      { x: 5, y: 4 },
      { x: 5, y: 3 },
      { x: 5, y: 2 },
      { x: 5, y: 1 },
  ...
  it('moveLeftStraightのテスト', () => {
    expect(move.moveLeftStraight(1, { x: 3, y: 3 })).toEqual([
      { x: 2, y: 3 },
      { x: 1, y: 3 },
      { x: 0, y: 3 },
    ])
    expect(move.moveLeftStraight(1, { x: 1, y: 0 })).toEqual([])
    expect(move.moveLeftStraight(2, { x: 0, y: 0 })).toEqual([])
    expect(move.moveLeftStraight(2, { x: 5, y: 5 })).toEqual([
      { x: 4, y: 5 },
      { x: 3, y: 5 },
      { x: 2, y: 5 },
      { x: 1, y: 5 },
  ...
  it('moveRightStraightのテスト', () => {
    expect(move.moveRightStraight(1, { x: 3, y: 3 })).toEqual([
      { x: 4, y: 3 },
      { x: 5, y: 3 },
      { x: 6, y: 3 },
      { x: 7, y: 3 },
    ...
    expect(move.moveRightStraight(1, { x: 8, y: 8 })).toEqual([])
    expect(move.moveRightStraight(2, { x: 0, y: 0 })).toEqual([
      { x: 1, y: 0 },
      { x: 2, y: 0 },
      { x: 3, y: 0 },
      { x: 4, y: 0 },
    ...
    expect(move.moveRightStraight(2, { x: 5, y: 5 })).toEqual([])
  })
  it('moveDiagonalのテスト', () => {
    expect(move.moveDiagonal(1, { x: 3, y: 3 })).toEqual([
      { x: 4, y: 2 },
      { x: 5, y: 1 },
      { x: 6, y: 0 },
      { x: 2, y: 2 },
    ...
    expect(move.moveDiagonal(1, { x: 1, y: 0 })).toEqual([])
    expect(move.moveDiagonal(2, { x: 0, y: 0 })).toEqual([
      { x: 1, y: 1 },
      { x: 2, y: 2 },
      { x: 3, y: 3 },
      { x: 4, y: 4 },
    ...
    expect(move.moveDiagonal(2, { x: 5, y: 5 })).toEqual([
      { x: 6, y: 6 },
      { x: 7, y: 7 },
      { x: 8, y: 8 },
      { x: 4, y: 6 },
